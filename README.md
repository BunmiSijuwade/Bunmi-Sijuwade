...
<br>
Technical Approach
I build prototypes first — wireframes, clickable prototypes, working code — to align teams before production. My sweet spot is taking data-heavy enterprise platforms and designing interfaces that feel intuitive, not overwhelming. Currently applying this methodology to AI products, using Claude and frontier models to rapidly prototype and iterate on UX.
Skills: Product management, enterprise SaaS, prompt engineering, Python, React, data visualization, platform integrations, stakeholder alignment
